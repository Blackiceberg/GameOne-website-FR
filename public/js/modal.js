...
const location1 = document.getElementById("NewYork");
const location2 = document.getElementById("SanFrancisco");
const location3 = document.getElementById("Seattle");
const location4 = document.getElementById("Chicago");
const location5 = document.getElementById("Boston");
const location6 = document.getElementById("Portland");
